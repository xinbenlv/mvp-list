...
- Index each place into a structured `Place` record.
...
The skill should identify the place, resolve one canonical reference, fill the Place schema as much as possible, and either write it to gbrain or pause with a JSON draft if gbrain is not installed or configured.
